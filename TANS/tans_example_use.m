...
Paths{2} = '~/tans/cifti/Utilities/msc'; % this folder contains ft_read / gifti functions for reading and writing cifti files (e.g., https://github.com/MidnightScanClub/MSCcodebase).
Paths{3} = '~/tans'; %
...
DataDir = '~/Data/'; % note: should be obvious, but user needs to manually define this
...
for i = 1:6
    ...
    % Note: A fixed stimulation intensity (/ = 1 A/s) is used during this stage of TANS because the strength of the E-field
    % varies linearly with / (the speed of variation of the current throughout the coil) and, for this reason,
